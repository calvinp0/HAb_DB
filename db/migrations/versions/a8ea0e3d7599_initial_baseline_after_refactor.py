...
Revision ID: a8ea0e3d7599
Revises:
Create Date: 2025-08-26 09:22:20.810817
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_lot_method_basis", "level_of_theory", ["method", "basis"], unique=False
    )
    op.create_table(
        "species",
    ...
    op.create_table(
        ...
        sa.Column("mol", db.sqltypes.Mol(), nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
        ...
        sa.ForeignKeyConstraint(
            ["lot_id"], ["level_of_theory.lot_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_index(
        op.f("ix_conformer_geometry_hash"), "conformer", ["geometry_hash"], unique=False
    )
    op.create_index(op.f("ix_conformer_lot_id"), "conformer", ["lot_id"], unique=False)
    op.create_index(
        op.f("ix_conformer_species_id"), "conformer", ["species_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_conformer_atom_conformer_id"),
        "conformer_atom",
        ["conformer_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "direction",
            sa.Enum("forward", "reverse", name="kin_direction", create_constraint=True),
            nullable=False,
        ),
        ...
        sa.ForeignKeyConstraint(
            ["reaction_id"], ["reactions.reaction_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "role",
            sa.Enum("R1H", "R2H", "TS", name="mol_role", create_constraint=True),
            nullable=False,
        ),
        sa.Column("conformer_id", sa.BigInteger(), nullable=False),
        sa.Column(
        ...
        sa.ForeignKeyConstraint(
            ["conformer_id"], ["conformer.conformer_id"], ondelete="RESTRICT"
        ),
        sa.ForeignKeyConstraint(
            ["reaction_id"], ["reactions.reaction_id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        op.f("ix_reaction_participant_conformer_id"),
        "reaction_participant",
        ["conformer_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_reaction_participant_reaction_id"),
        "reaction_participant",
        ["reaction_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_ts_features_lot_id"), "ts_features", ["lot_id"], unique=False
    )
    op.create_table(
        "well_features",
        sa.Column("conformer_id", sa.BigInteger(), nullable=False),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["from_atom_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["from_conformer_id"], ["conformer.conformer_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["ts_atom_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["ts_conformer_id"], ["conformer.conformer_id"], ondelete="CASCADE"
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["a1_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["a2_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["a3_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["conformer_id"], ["conformer.conformer_id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_gang_measure_val",
        "geom_angle",
        ["measure_name", "value_deg"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geom_angle_conformer_id"), "geom_angle", ["conformer_id"], unique=False
    )
    op.create_table(
        "geom_dihedral",
        sa.Column("geom_id", sa.BigInteger(), nullable=False),
        ...
        sa.ForeignKeyConstraint(
            ["a4_id"], ["conformer_atom.atom_id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["conformer_id"], ["conformer.conformer_id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_gdih_measure_val",
        "geom_dihedral",
        ["measure_name", "value_deg"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geom_dihedral_conformer_id"),
        "geom_dihedral",
        ["conformer_id"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_gdist_measure_val",
        "geom_distance",
        ["measure_name", "value_ang"],
        unique=False,
    )
    op.create_index(
        op.f("ix_geom_distance_conformer_id"),
        "geom_distance",
        ["conformer_id"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_reaction_participant_reaction_id"), table_name="reaction_participant"
    )
    op.drop_index(
        op.f("ix_reaction_participant_conformer_id"), table_name="reaction_participant"
    )
